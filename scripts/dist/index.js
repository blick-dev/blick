...
let Scripts = class Scripts {
    init(n, id, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.exec(`rm -rf ${ctx.directory}/../electron`, true);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const device of screenshots_1.devices) {
                ...
                for (const r of screenshots_1.routes) {
                    ...
                    yield page.goto(`http://localhost:8100/${r.path}`, {
...
__decorate([
    ...
    __param(0, billy_core_1.param(params_1.platform)),
    __param(1, billy_core_1.param(params_1.prod)),
    __param(2, billy_core_1.context()),
    __metadata("design:type", Function),
